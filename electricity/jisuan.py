...
if __name__ == '__main__':
        ...
        #         data = f.read ()  # 读取文件
        #         print(data)
        with open ("bzl-master-control.txt", "rb") as data:
                # header = data.read (8)
                ...
                for n in range(0,maxNum):
                        startSite = text.find (r"/n双绳卷扬伺服电流", initialSite)+ textlen
                        endSite = text.find (r"/n", startSite)
                        initialSite = endSite
                ...
                # print(liuliang)
                for n in range(0,maxNum):
                    # print(int(liuliang[n],16)/100)
                    reslut[n] = int(liuliang[n],16)/100
                print(reslut)
